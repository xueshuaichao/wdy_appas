<template>
    ...
    >
        ...
        <formItemWithHelp
            ...
            :rules="[
                { required: true, message: '请输入允许上传视频数', trigger: 'blur' },
                integerRule
            ]"
        >
            <a-input-number
        ...
        <formItemWithHelp
            ...
            help-txt="单个视频不能超过1000Mb"
            :rules="[
                { required: true, message: '请输入最大视频尺寸', trigger: 'blur' },
                integerRule
            ]"
        >
            <a-input-number
                v-model="attr.maxFileSize" :min="1" :max="1000"
                class="width100"
                :formatter="limitDecimals"
                :parser="limitDecimals"
