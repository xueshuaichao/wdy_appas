<template>
    <form-item-with-help
        ...
        :help-txt="attr.hint"
    >
        <a-select v-model="form[attr.apiName]" :placeholder="attr.defaultPrompt" @change="handleFieldChange">
            <a-select-option
                v-for="option in filterOptions" :key="option.value" :value="option.value"
            >
                {{ option.label }}
            </a-select-option>
        </a-select>
